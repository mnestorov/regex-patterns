...
:warning: **If you prefer, you can use the [Regex Pattern Generator](https://mnestorov.github.io/regex-patterns/) online tool, but keep in mind that the RPG tool is still under development!**
...
##### VAT Number
- **Pattern:** `^BE[01]\d{9}$`
- **Description:** Belgian VAT numbers start with "BE01", followed by 9 digits. More info: [Standard format of Belgian VAT number updated](https://www.vatcalc.com/belgium/belgian-vat-number-format-changes/) 
